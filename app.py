...
def make_svg():
    ...
    for ax in [axs[0,1]]:
        ax.bar(df_forcast["time"], df_forcast["precipitation"]*4.0, label="Precipitation [mm/h]", color=colour_dict["frost_green"], width = 0.005)
    ...
    for ax in [axs[1, 0]]:
        ...
        ax.bar(df_birch_0_10["time"],   df_birch_0_10["birch_pollen"],   color=colour_dict["aurora_green"],  width = 0.002)
        ax.bar(df_birch_10_20["time"], df_birch_10_20["birch_pollen"], color=colour_dict["aurora_yellow"], width = 0.002)
        ax.bar(df_birch_20_100["time"], df_birch_20_100["birch_pollen"], color=colour_dict["aurora_red"], width = 0.002)
        ax.bar(df_birch_100["time"],    df_birch_100["birch_pollen"],    color=colour_dict["aurora_purple"],    width = 0.002)
    for ax in [axs[1, 1]]:
